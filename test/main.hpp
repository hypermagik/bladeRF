...
inline double tx_delay = 0.02;
inline unsigned message_size = 8192;
inline unsigned meta_size = 16;
...
inline struct Rx {
  ...
  const unsigned nof_buffers = 16 + 1;
  const unsigned nof_transfers = 16;
  unsigned samples_per_buffer = 8192;
  unsigned valid_samples_per_buffer;
...
inline struct Tx {
  ...
  const unsigned nof_buffers = 16 * 2;
  const unsigned nof_transfers = 16;
  unsigned samples_per_buffer = 8192;
  unsigned valid_samples_per_buffer;
